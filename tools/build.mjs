...
<head>
  ...
  <link rel="icon" href="${prefix}assets/avatar.png">
...
<body>
  ...
  <header class="site-header">
    <div class="container">
      <a class="logo" href="${prefix}index.html" aria-label="${profile.name} 홈">${profile.handle}<span class="logo-dot">.</span></a>
...
${renderExperience('', { headingLevel: 3, compact: true })}
    ...
    <section id="contact" class="section container" aria-labelledby="contact-title">
      <div class="contact-card">
        <div>
          <h2 id="contact-title">함께 이야기 나눠요</h2>
          <p>채용, 협업, 기술 이야기 모두 환영합니다. 이메일로 연락 주세요.</p>
        </div>
