...
export const caseStudies = [
  ...
  },
  {
    ...
    summary: '지마켓 · 옥션 · ESMPLUS 세 사이트에 따로 흩어져 있던 약관을 한 서비스에서 관리하게 만든 프로젝트입니다. 약관을 코드 · 버전 · 시행일자로 다루는 모델부터, 세 사이트의 공개 약관 페이지, HTML 에디터가 붙은 어드민까지 한 묶음으로 만들었고 지금도 운영 중입니다.',
    cardPoints: [
    ...
    features: [
      ...
      ['법령 대응 필드', '재동의 · 선동의 · 대체동의 · 고지 · 동의 연동'],
    ],
    ...
    story: [
      ...
      { heading: '약관을 세 가지로 나눠서 보기', paragraphs: [
        '먼저 용어부터 정했습니다. 약관은 약관코드 하나로 관리되는 본체이고, 약관그룹은 화면 하나에 함께 노출되는 약관들의 묶음이며, 그룹 매핑은 그 둘을 실제로 잇는 관계입니다. 예를 들어 지마켓 개인 구매회원 가입 화면 하나에 약관 여섯 개가 매핑되어 있는 식입니다.',
      ...
      { heading: '남은 것', paragraphs: [
        '버전 번호 자동 증가는 등록 실수를 직접 고칠 수 있도록 일부러 수동으로 남겨 두었고, 노출 스타일(팝업 · 폴딩) 속성을 약관 테이블에 둘지 그룹 매핑에 둘지는 후속 과제로 남겼습니다. 약관 동의 API를 가입 · 전환 흐름에 붙이고 기존 동의 테이블을 정리하는 일도 다음 단계입니다. 대응 시간이 얼마나 줄었는지는 비교 집계가 없어 수치로 말하지 않습니다.',
      ] },
    ],
