...
export function termsDiagram() {
  ...
  // 동의 서비스
  p.push(chip(30, 300, 240, 50, '약관 동의 서비스 · 운영 중', '회원별 동의 내역 · 가입 · 전환 시 동의 API'));
  p.push(elbow(270, 325, 300, 241, { mx: 285 }));
  p.push(text(150, 366, '미래편으로 제시 → 이어서 개발', { size: 9.5, fill: 'var(--accent)', weight: 600 }));
